...
set_target_properties(opencv_legacy PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_legacy.so"
  IMPORTED_SONAME_RELEASE "libopencv_legacy.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_legacy )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_legacy "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_legacy.so" )
...
set_target_properties(opencv_gpu PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_gpu.so"
  IMPORTED_SONAME_RELEASE "libopencv_gpu.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_gpu )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_gpu "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_gpu.so" )
...
set_target_properties(opencv_ocl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_ocl.so"
  IMPORTED_SONAME_RELEASE "libopencv_ocl.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ocl )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ocl "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_ocl.so" )
...
set_target_properties(opencv_nonfree PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_nonfree.so"
  IMPORTED_SONAME_RELEASE "libopencv_nonfree.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_nonfree )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_nonfree "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_nonfree.so" )
...
set_target_properties(opencv_contrib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_contrib.so"
  IMPORTED_SONAME_RELEASE "libopencv_contrib.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_contrib )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_contrib "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_contrib.so" )
