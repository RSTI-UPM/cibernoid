...
OPENCV_MODULES:=calib3d contrib core features2d flann highgui imgproc legacy ml nonfree objdetect ocl photo stitching superres ts androidcamera video videostab
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    OPENCV_LIBS:=calib3d contrib core features2d flann highgui imgproc legacy ml nonfree objdetect ocl photo stitching superres ts androidcamera video videostab
    OPENCV_LIB_TYPE:=SHARED
else
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    ...
    ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
        OPENCV_3RDPARTY_COMPONENTS:=
        OPENCV_EXTRA_COMPONENTS:=m log dl
    endif
    ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
        OPENCV_3RDPARTY_COMPONENTS:=
        OPENCV_EXTRA_COMPONENTS:=m log dl
