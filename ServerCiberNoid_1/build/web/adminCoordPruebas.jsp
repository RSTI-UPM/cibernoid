    ...
    <body>
		...
		out.println("</tr>");
            ...
            if(a==null){
             ...
             String query = "INSERT INTO coordenadas(id,latitud,longitud,radio) VALUES (1,'1.02','1.03',2)";
                // create the mysql insert preparedstatement
   
                PreparedStatement preparedStmt = connection.prepareStatement(query);
                /*preparedStmt.setInt (1, 1);
                preparedStmt.setFloat (2, latitud);
                preparedStmt.setFloat (3, longitud);
                preparedStmt.setInt(4, radio);*/
                preparedStmt.execute();
                preparedStmt.close();
                
            Statement stmt2 = connection.createStatement();  
            
            ResultSet rs2= stmt2.executeQuery("SELECT * FROM coordenadas");
            
            
            while(rs2.next()){
                //out.println("Nombre: "+ rs.getString("nombre")+" ; Id: "+rs.getInt("id")+ " ; Departamento: "+rs.getInt("departamento"));
                out.println("<tr class='info'>");
		out.println("<td class='text-center'>"+rs2.getFloat(2)+"</td>");			
		out.println("<td class='text-center'>"+rs2.getFloat(3)+"</td>");
		out.println("<td class='text-center'>"+rs2.getInt(4)+"</td>");
		out.println("</tr>");
